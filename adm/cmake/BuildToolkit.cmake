...
if (DIPCAD_INSTALL_CUSTOM)
	install(FILES ${TOOLKIT_HEADER_FILES}
		DESTINATION ${DIPCAD_INSTALL_INCLUDE_DIR} COMPONENT Development
		)
endif()
...
if (DIPCAD_INSTALL_CUSTOM)
	install(TARGETS ${TOOLKIT}
		EXPORT DIPCAD-OCE-libraries
		RUNTIME DESTINATION ${DIPCAD_INSTALL_BIN_DIR} COMPONENT RuntimeLibraries
		LIBRARY DESTINATION ${DIPCAD_INSTALL_LIB_DIR} COMPONENT RuntimeLibraries
		ARCHIVE DESTINATION ${DIPCAD_INSTALL_LIB_DIR} COMPONENT Development
		)
endif()
...
if(MSVC AND OCE_INSTALL_PDB_FILES AND OCE_BUILD_SHARED_LIB)
	...
	if (DIPCAD_INSTALL_CUSTOM)
		if (CMAKE_CONFIGURATION_TYPES)
			install(FILES ${LIBRARY_OUTPUT_PATH}/RelWithDebInfo/${TOOLKIT}.pdb
				DESTINATION ${DIPCAD_INSTALL_BIN_DIR} CONFIGURATIONS RelWithDebInfo)
			install(FILES ${LIBRARY_OUTPUT_PATH}/Debug/${TOOLKIT}${CMAKE_DEBUG_POSTFIX}.pdb
				DESTINATION ${DIPCAD_INSTALL_BIN_DIR} CONFIGURATIONS Debug)
		else(CMAKE_CONFIGURATION_TYPES)
			install(FILES ${LIBRARY_OUTPUT_PATH}/${TOOLKIT}.pdb
				DESTINATION ${DIPCAD_INSTALL_BIN_DIR} CONFIGURATIONS RelWithDebInfo)
			install(FILES ${LIBRARY_OUTPUT_PATH}/${TOOLKIT}${CMAKE_DEBUG_POSTFIX}.pdb
				DESTINATION ${DIPCAD_INSTALL_BIN_DIR} CONFIGURATIONS Debug)
		endif (CMAKE_CONFIGURATION_TYPES)
	endif()
